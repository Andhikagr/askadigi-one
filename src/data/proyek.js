...
export const proyek = [
  {
    ProjectOne: {
      images: Array.from({ length: 12 }, (_, i) => `/Multi/Multi-${i + 1}.png`),
      tech: ["Laravel", "Inertia", "MySQL", "React"],
    },
    ProjectTwo: {
      images: Array.from(
        { length: 10 },
        (_, i) => `/SingleOne/So-${i + 1}.png`
      ),
      tech: ["Laravel", "Inertia", "MySQL", "React"],
    },
    ProjectThree: {
    ...
    ProjectFour: {
      images: Array.from({ length: 12 }, (_, i) => `/Umroh/um${i + 1}.png`),
      tech: ["HTML5", "CSS3", "Javascript"],
    },
    ProjectFive: {
      images: Array.from({ length: 3 }, (_, i) => `/Rentals/cr-${i + 1}.png`),
      tech: ["Flutter", "Golang"],
    },
  },
];
